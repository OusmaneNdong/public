...
export function resetPasswordRequest(http: HttpClient, rootUrl: string, params: ResetPasswordRequest$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
